  ...
  return (
    <header className="bg-white border-b border-gray-200">
      <div className="md:container md:mx-auto sm:px-4 lg:px-6 py-2 flex justify-between items-center">
        ...
        <div>
          <Link href="./login" className="block rounded-lg px-3 py-2.5 text-sm md:text-xl font-semibold text-bcolor hover:bg-gray-50 shadow-sm hover:shadow-md hover:text-primary">Log in
